...
#define	ENEMY_BULLET_FIRE_INTERVAL	0.5
//#define	ENEMY_BULLET_FIRE_INTERVAL	0.5
#define	ASTEROID_COUNT	5
#define	SPACESHIP_COUNT	1
#define ASTEROID_DISPLAY_WINDOW 5
#define	ENEMY_SPACESHIP_COUNT	2
#define	ENEMY_SPACESHIP_STEP	1
#define	SPACESHIP_MOVE_STEP	3
#define	ASTEROID_MOVE_STEP	2
#define	BULLET_COUNT	100
#define	BULLET_MOVE_STEP	5
